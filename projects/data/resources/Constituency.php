...
class Constituency
{
	 ...
	 * A special parameter \c _datetime can be used (eg. '_datetime' => '2010-06-30 9:30:00') to select only the constituencies
	 * valid at the given moment (the ones where \c since <= \c _datetime < \c until).
	 * Use <code>'_datetime' => 'now'</code> to get constituencies valid now.
	 *
	 * \return An array of constituencies that satisfy all prescribed column values.
	 *
	 * \ex
	 * \code
	 * read(array('short_name' => '5', 'parliament_code' => 'cz/senat', '_datetime' => 'now'))
	 * \endcode returns
	 * \code
	 * Array
	 * (
