 ...
 * \ingroup data
 *
 * Provides an interface to database table DIVISION_ATTRIBUTE that holds divisions' additional attributes.
 *
 * Columns of table division_ATTRIBUTE are: <code>division_id, name, value, lang, since, until</code>.
 *
 * All columns are allowed to write to.
 *
 * Primary key consists of columns <code>division_id, name, lang, since</code>.
 */
class DivisionAttribute
{
	...
	public function __construct()
	{
		$this->attribute = new Attribute(array(
			'name' => 'division_attribute',
			'columns' => array('division_id')
		));
	}

	/**
	 * Read the division attribute(s) that satisfy given parameters.
	 *
	...
	/**
	 * Create a division attribute(s) from given values.
	 *
	...
	/**
	 * Update the given values of the division attributes that satisfy given parameters.
	 *
	...
	/**
	 * Delete the division attribute(s) that satisfy given parameters.
	 *
