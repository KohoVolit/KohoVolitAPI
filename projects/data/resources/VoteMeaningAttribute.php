 ...
 * \ingroup data
 *
 * Provides an interface to database table VOTE_MEANING_ATTRIBUTE that holds vote meaning's additional attributes.
 *
 * Columns of table VOTE_MEANING_ATTRIBUTE are: <code>vote_meaning_code, name, value, lang, since, until</code>.
 *
 * All columns are allowed to write to.
 *
 * Primary key consists of columns <code>vote_meaning_code, name, lang, since</code>.
 */
class VoteMeaningAttribute
{
	...
	public function __construct()
	{
		$this->attribute = new Attribute(array(
			'name' => 'vote_meaning_attribute',
			'columns' => array('vote_meaning_code')
		));
	}

	/**
	 * Read the vote meaning attribute(s) that satisfy given parameters.
	 *
	...
	/**
	 * Create a vote meaning attribute(s) from given values.
	 *
	...
	/**
	 * Update the given values of the vote meaning attributes that satisfy given parameters.
	 *
	...
	/**
	 * Delete the vote meaning attribute(s) that satisfy given parameters.
	 *
