...
class MpDetails
{
	...
	public function read($params)
	{
		...
		$query = new Query();
		$query->setQuery(
			"select id, first_name, middle_names, last_name, disambiguation, sex, mpa.\"name\" as attr_name, mpa.\"value\" as attr_value, p.code as parliament_code, p.\"name\" as parliament_name from mp\n" .
