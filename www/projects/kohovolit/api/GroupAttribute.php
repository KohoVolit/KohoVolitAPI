...
class GroupAttribute extends Attribute
{
	...
	/**
	 * Retrieve MP group(s)' attributes according to given parameters.
	 *
	...
	{
		return parent::retrieveAttr($params, 'group_attribute');
	}
	...
	{
		return parent::createAttr($data, 'group_attribute');
	}
	...
	{
		return parent::updateAttr($params, $data, 'group_attribute');
	}
	...
	{
		return parent::deleteAttr($params, 'group_attribute');
	}
}

GroupAttribute::initColumnNames();
