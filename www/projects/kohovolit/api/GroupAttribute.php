...
class GroupAttribute extends Attribute
{
	...
	{
		return parent::readAttribute($params, 'group_attribute');
	}
	...
	{
		return parent::createAttribute($data, 'group_attribute');
	}
	...
	{
		return parent::updateAttribute($params, $data, 'group_attribute');
	}
	...
	{
		return parent::deleteAttribute($params, 'group_attribute');
	}
}
