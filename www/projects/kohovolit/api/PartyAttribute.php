...
class PartyAttribute extends Attribute
{
	...
	{
		return parent::readAttribute($params, 'party_attribute');
	}
	...
	{
		return parent::createAttribute($data, 'party_attribute');
	}
	...
	{
		return parent::updateAttribute($params, $data, 'party_attribute');
	}
	...
	{
		return parent::deleteAttribute($params, 'party_attribute');
	}
}
