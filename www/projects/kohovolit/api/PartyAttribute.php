...
class PartyAttribute extends Attribute
{
	...
	/**
	 * Retrieve party(s)' attributes according to given parameters.
	 *
	...
	{
		return parent::retrieveAttr($params, 'party_attribute');
	}
	...
	{
		return parent::createAttr($data, 'party_attribute');
	}
	...
	{
		return parent::updateAttr($params, $data, 'party_attribute');
	}
	...
	{
		return parent::deleteAttr($params, 'party_attribute');
	}
}

PartyAttribute::initColumnNames();
